...
class SuggestionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.plus).setOnClickListener {
            (requireActivity() as MainActivity).supportFragmentManager.beginTransaction().replace(R.id.navHostFragment, RegistractionFragment()).commit()
        }

        recyclerView = view.findViewById<RecyclerView>(R.id.recyclerview_suggest).apply {
